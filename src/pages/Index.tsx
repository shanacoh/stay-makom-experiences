...
CHOOSE YOUR ESCAPE</h2>
        ...
        <section className="relative h-[500px] md:h-[600px] flex items-start justify-start">
          ...
          <div className="relative z-10 text-left text-foreground px-4 pt-12 md:pt-16 max-w-4xl ml-2 sm:ml-4 md:ml-8 lg:ml-[1cm]">
            ...
            <h2 className="font-sans mb-4 tracking-[-0.02em] animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-200 font-bold text-slate-950 md:text-7xl text-4xl">From the desert to the sea, from vineyards to kibbutzim, (RE)discover Israel through experiences that fl like nowhere else.</h2>
