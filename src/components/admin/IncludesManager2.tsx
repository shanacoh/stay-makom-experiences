...
const IncludesManager2 = ({ experienceId }: IncludesManager2Props) => {
  ...
  const [editData, setEditData] = useState({ title: "", title_he: "" });
  ...
  const startEditing = (include: any) => {
    ...
    setEditData({ title: include.title || "", title_he: include.title_he || "" });
  ...
  const saveEdit = (include: any) => {
    ...
    updateMutation.mutate({ id: include.id, icon_url: include.icon_url });
  };
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-end gap-3">
            <div className="w-32 flex-shrink-0">
              ...
              <Button type="button" variant="outline" className="w-full justify-start mt-2" onClick={() => document.getElementById("new-include2-image")?.click()}>
              ...
              {imagePreview && (
                <div className="mt-2 relative">
                  ...
                  <Button type="button" variant="ghost" size="icon" className="absolute -top-2 -right-2 h-6 w-6 rounded-full bg-background" onClick={() => { setImageFile(null); setImagePreview(null); }}>
                    <X className="w-3 h-3" />
                  </Button>
                </div>
              )}
                ...
                {editingId === include.id ? (
                  <div className="flex-1 flex items-center gap-3">
                    <div className="w-20 flex-shrink-0">
                      <Button type="button" variant="outline" size="sm" onClick={() => document.getElementById(`edit-image2-${include.id}`)?.click()}>
